								...
								<div class="home_content">
									<div class="breadcrumbs">
										<ul>
											...
											<li><a href="categories1.php">Danh mục hãng</a></li>
											<li>Giỏ hàng mua sắm</li>
										</ul>
									</div>
								</div>
							</div>
			...
			<div class="container">
				<div class="row">
					<div class="col">
						...
						<div class="cart_info_columns clearfix">
							...
							<div class="cart_info_col cart_info_col_price">Giá tiền</div>
					...
					<div class="col">
						<div class="cart_buttons d-flex flex-lg-row flex-column align-items-start justify-content-start">
							...
							<div class="button continue_shopping_button">
								<a href="categories1.php">Tiếp tục mua hàng</a>
							</div>
							<div class="cart_buttons_right ml-lg-auto row">
								<div class="button clear_cart_button">
									<a href="cart.php?action=clear">Xoá giỏ hàng</a>
								</div>
								<div class="button update_cart_button">
									<button type="submit" style="width: 100%;height: 100%; margin: 0;" class="btn ">Update giỏ hàng</button>
								</div>
				...
				<div class="row row_extra">
					<div class="col-lg-4">
						...
						<!-- Delivery -->
						<div class="delivery">
							<div class="section_title">Phương pháp vận chuyển</div>
							<div class="section_subtitle">Chọn 1 nếu bạn muốn</div>
							...
							<label class="delivery_option clearfix">Standard delivery
								...
								<label class="delivery_option clearfix">Vận chuyển đường bộ
					...
					<div class="col-lg-6 offset-lg-2">
						<div class="cart_total">
							<div class="section_title">Tổng số lượng trong giỏ hàng</div>
							...
							<div class="button checkout_button"><a href="checkout.php">Tiến hành thanh toán</a></div>
						</div>
					</div>
				</div>
			</div>
