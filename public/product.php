...
<div class="super_container">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url(images/banner4.jpg)"></div>
			<div class="home_content_container">
				<div class="container">
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Men clothes<span>.</span></div>
								<div class="home_text"><p>Quần áo nam.</p></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					<div class="details_image">
						<div class="details_image_large"><img src="../resources/uploads/<?php echo $row['product_image']?>" alt=""><div class="product_extra product_new"><a href="categories.html">Mới</a></div></div>
				...
				<div class="col-lg-6">
					<div class="details_content">
						...
						<div class="in_stock_container">
							<div class="availability">Khả dụng:</div>
							<span>Trong kho</span>
						</div>
						...
						<div class="product_quantity_container">
							...
							<form action="" method="post">
								...
								<?PHP if(!$isExisting) { ?>
								<div class="button">
									<button type="submit" style="width: 100%;height: 100%; margin: 0;" class="btn cart_button">Thêm vào giỏ hàng</button>
								</div>
								<?PHP } else { ?>
									<span class="badge">Đã sẵn sàng trong giỏ hàng</span>
								<?PHP } ?>
							</form>
		...
		<div class="container">
			<div class="row">
				<div class="col text-center">
					<div class="products_title">Các sản phẩm có liên quan</div>
				</div>
			</div>
			<div class="row">
				<div class="col">
