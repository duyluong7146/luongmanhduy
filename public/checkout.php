						...
						<div class="col-lg-6">
							<div class="billing checkout_section">
								...
								<div class="checkout_form_container">
									...
									<div>
										<!-- Name -->
										<label for="checkout_address">Tên*</label>
									...
									<div class="checkout_extra">
										<div>
											...
											<span class="checkbox_title">Đồng ý các điều khoản và điều kiện</span>
										</div>
									</div>
						...
						<div class="col-lg-6">
							<div class="order checkout_section">
								...
								?>
											...
											<li class="d-flex flex-row align-items-center justify-content-start">
												<div class="order_list_title">Tổng tiền sản phẩm</div>
